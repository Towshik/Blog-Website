...
$current_user = $_SESSION['username']; 
        ...
        else if ($_SESSION['role']!="Star Admin" and $_SESSION['role']!="Admin" ){
            header("location:index.php");}
?>
<!DOCTYPE html>
<html>
	...
	<div id="main-wrapper">
        ...
        <?php 
         if(isset($_POST['changeinfo'])){
           $admin=new Admin();
           $update = $admin->updateadminpassword($_POST['opassword'],$_POST['npassword'],$_POST['cpassword']);  
      if($update){  
