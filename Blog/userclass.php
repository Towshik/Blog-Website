...
{  public $db;
	...
	public function editstatus($username, $title, $status,$edited_post) {  
		$query = "INSERT INTO requests(`username`,`title`,`status`,`postid`) 
		          VALUES ('$username','$title','$status','$edited_post')";
		$check = mysqli_query($this->db->dbh,$query);  
		if($check)
				{
					return true;
	...
	public function editstatuswithimage($username, $title, $status,$image,$edited_post) {  
		$query = "INSERT INTO requests(`username`,`title`,`status`,`image`,`postid`) 
		VALUES ('$username','$title','$status','$image','$edited_post')";
		$check = mysqli_query($this->db->dbh,$query);  
		if($check)
				{
					return true;
